...
<body>
    <?php
        ...
        if($_SESSION["pergunta1"] == "Ninguém sabe"){
            $acertos++;
            $resultado1 = "Acertou";
        } else {
            $resultado1 = "Errou";
        }
        if($_SESSION["pergunta2"] == "Juju e Gigi"){
            $acertos++;
            $resultado2 = "Acertou";
        } else {
            $resultado2 = "Errou";
        }
        if($_SESSION["pergunta3"] == "Lara"){
            $acertos++;
            $resultado3 = "Acertou";
        } else {
            $resultado3 = "Errou";
        }
        if($_SESSION["pergunta4"] == "Steve Magal"){
            $acertos++;
            $resultado4 = "Acertou";
        } else {
            $resultado4 = "Errou";
        }
        if($_SESSION["pergunta5"] == "Abacate"){
            $acertos++;
            $resultado5 = "Acertou";
        } else {
            $resultado5 = "Errou";
    ...
    <div id="navegacao">
        ...
        <ul>
            <li><a href="index.html">Quiz - Cookies</a></li>
            <li id="selecionado"><a href="sessions-index.html">Quiz - Sessions</a></li>
        </ul>
    </div>
    <div id="conteudo">
        ...
        <table>
            ...
            <tr>
                ...
                <td>Abacate</td>
                <td><?php echo $_SESSION["pergunta5"];?></td>
